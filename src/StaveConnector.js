...
var MEI2VF = (function(m2v, VF, $, undefined) {
  ...
  m2v.Connectors.prototype = {
    ...
    createVexFromModels : function(currentMeasure, barline_l, barline_r,
        currentSystem) {
      var me = this, vexType, top_staff, bottom_staff, vexConnector, label;
      $.each(me.currentModels, function(i, model) {

        vexType = (barline_r)
            ? me.vexTypesBarlineRight[barline_r]
            : me.vexTypes[model.symbol];
