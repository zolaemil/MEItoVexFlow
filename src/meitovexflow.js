...
var MEI2VF = ( function(m2v, VF, $, undefined) {
    ...
    m2v.Renderer = function(config) {
      if (config)
        this.initConfig(config).process().draw();
      return this;
    };
    ...
    m2v.Renderer.prototype = {
      ...
      process : function(newXmlDoc) {
        var me = this, xmlDoc;
        xmlDoc = newXmlDoc || me.cfg.xmlDoc;
        me.reset();
      ...
      reset : function() {
        ...
        me.startConnectors = new m2v.Connectors(me.cfg.labelScheme);
      ...
      addMissingMeasureWidths : function(widths) {
        ...
        nonSpecifiedMeasureWidth = Math.floor((me.cfg.printSpaceWidth - me.currentSystemMarginLeft - totalSpecifiedMeasureWidth) / nonSpecified_n);
        for ( i = 0, j = widths.length; i < j; i += 1) {
          if (widths[i] === null)
